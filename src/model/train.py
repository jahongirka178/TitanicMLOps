...
def train_pipeline(X, y, cat_features: list | None = None, output_dir: str | Path = "artifacts", **model_kwargs):
    ...
    # сохраняем валидационные предсказания и вероятности
    joblib.dump({"y_val": y_val, "proba": preds_proba, "preds": preds}, Path(output_dir) / "val_predictions.pkl")
